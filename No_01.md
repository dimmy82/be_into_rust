...
- **Mutableな参照は同時に複数存在できない**
  - edition-2018の[Non-lexical lifetimes](https://doc.rust-lang.org/edition-guide/rust-2018/ownership-and-lifetimes/non-lexical-lifetimes.html)の場合、ライフタイムが広い方が使われるまでの間に、他のmut参照が宣言されたらコンパイルエラーになる
  - edition-2018の場合、下記の例だと、s2とs3の宣言順番が逆にしたらコンパイルエラーにはならない
