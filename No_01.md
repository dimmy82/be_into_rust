...
- **参照とMutableな参照は同時に混在できない**
  - edition-2018の[Non-lexical lifetimes](https://doc.rust-lang.org/edition-guide/rust-2018/ownership-and-lifetimes/non-lexical-lifetimes.html)の場合、mut参照が使われるまでの間に、他の参照が宣言されたらコンパイルエラーになる
